...
return [
    ...
    */
    ...
    // Rate limiting: max emails per hour (default: 400)
    'rate_limit' => env('EMAIL_MARKETING_RATE_LIMIT', 400),

    // Base delay between emails (seconds) - 9 sec = ~400 emails/hour
    'base_delay' => env('EMAIL_MARKETING_BASE_DELAY', 9),

    // Random delay range (seconds) - adds 0 to this value for natural variation
    'random_delay' => env('EMAIL_MARKETING_RANDOM_DELAY', 3),

    // Queue name for Horizon (use dedicated queue for email sending)
    'queue' => env('EMAIL_MARKETING_QUEUE', 'email-marketing'),
